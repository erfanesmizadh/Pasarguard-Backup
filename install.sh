#!/bin/bash
# =====================================================
# PASARGUARD BACKUP INSTALLER & MANAGER - PROFESSIONAL
# Author: AVASH_NET
# Full TCP MySQL, Telegram Ready, Large File Safe
# Colorful Menu, Structured, Automated Config
# =====================================================
...
# ---------------- Banner ----------------
echo -e "${CYAN}==============================================="
echo -e "      🔹 PASARGUARD BACKUP SYSTEM 🔹"
echo -e "===============================================${RESET}"
...
for cmd in mysqldump zip curl; do
